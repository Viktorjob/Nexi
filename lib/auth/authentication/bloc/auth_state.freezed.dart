...
extension AuthStatePatterns on AuthState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case EmailVerificationSent() when emailVerificationSent != null:
        return emailVerificationSent(_that);
...
class EmailVerificationSent implements AuthState {
  const EmailVerificationSent();

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is EmailVerificationSent);
  }
